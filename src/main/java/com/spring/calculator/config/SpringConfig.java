...
public class SpringConfig {
    ...
    // Bean atitinka Singleton šabloną - programinės įrangos projektavimo schemą,
    // kuri riboja klasės įvykdymą vienu "vieninteliu" egzemplioriumi.
    // Tai naudinga, kai reikia tiksliai vieno objketo, norint koordinuoti veiksmus visoje sistemoje.
    @Bean
    // @Qualifier anotacija kartu su @Autowired patikslina su kuriuo konkre2iai bean susieti priklausomybę.
